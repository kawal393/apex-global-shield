    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 bg-gold/10 border border-gold/20 rounded-full px-4 py-2 mb-6">
          ...
          <span className="text-gold text-xs tracking-widest font-heading">SCP-1 PROTOCOL</span>
        </div>
        <h1 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-4">THE GENESIS STRIKE</h1>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          The Sovereign Consumer Protocol — A Declaration of Digital Independence
        </p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            {[
              ...
              'PERMANENCE: These shields will never be paywalled, never be restricted, never be sold.'
            ].map((principle, i) => (
        ...
        <div className="card border-gold/30">
          ...
          <p className="text-muted-foreground leading-relaxed mb-6">
            Apex Global Shield will always be free. We will never charge for consumer protection. We will never sell your data. We will never compromise our mission for profit. The shields are yours. Forever.
          </p>
